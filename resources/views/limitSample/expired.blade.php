...
@section('header')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Limit Sample - <strong>Expired</strong></h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">
                    <strong href="index.html">All Expired Limit Sample</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#expired').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('limitSample.allExpired') }}", // Ensure this route points to your DataTable data
                columns: [
                    // {
                    //     data: 'id',
                    //     name: 'id',
