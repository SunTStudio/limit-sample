...
@section('header')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Limit Sample - <strong>Will Expired</strong></h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">
                    <strong href="index.html">Limit Sample Will Expired</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
...
@section('content')
    <div class="row justify-content-center m-3">
        <div class="col bg-white p-3">
            <table id="expired" class="display ">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Model Part</th>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#expired').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('limitSample.willExpired') }}", // Ensure this route points to your DataTable data
                columns: [
                    // {
                    //     data: 'id',
                    //     name: 'id',
                    ...
                    { data: 'days_until_expired', name: 'days_until_expired', className: 'text-center',render:function(data,type,row){
                        return `${data} more days`;
                    } },
                    {
                        data: 'expired_date',
                        name: 'expired_date',
