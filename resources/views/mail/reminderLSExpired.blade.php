...
<head>
    ...
    <title>Notifikasi Expired Limit Sample</title>
</head>
<body style="color: black; font-family: Arial, sans-serif;">

    <h2 style="font-weight: bold;">Notifikasi Expired Limit Sample</h2>
    <p style="font-size: 16px;">
        Ditemukan adanya Dokumen Limit Sample yang sudah Expired Berikut Rinciannya :
    </p>
