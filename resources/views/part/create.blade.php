        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    <form method="POST" action="{{ url("/limit-sample/model/$model->id/part/create") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-file">
                                    <input id="logo" type="file" name="foto_part" class="custom-file-input" required>
